...
ap.add_argument("--threshold", type=float, default=0.1,
                help="Near-surface threshold for UDF (default: 0.1)")
...
workspacePath = "data/"
targetPath = "obj/"
savePath = args.save_path if args.save_path else ("npz-udf-uniform/" if use_uniform_only else "npz-udf/")
...
for path in AB_paths:
    ...
    # Match enriched total: near_surface*10 + uniform = 352000 for full mode
    ...
    if use_minimal:
        ...
        uniform_num = total_enriched  # all uniform, same total count
        near_surface_num = 0
    else:
        near_surface_num *= 10
